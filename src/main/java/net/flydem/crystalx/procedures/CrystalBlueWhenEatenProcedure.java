	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				CrystalxMod.LOGGER.warn("Failed to load dependency entity for procedure CrystalBlueWhenEaten!");
			return;
		}
		...
		if (entity instanceof PlayerEntity && !entity.world.isRemote()) {
			((PlayerEntity) entity).sendStatusMessage(new StringTextComponent(("" + new java.text.DecimalFormat(
					"\u041E\u0434\u043D\u043E\u0432\u0440\u0435\u043C\u0435\u043D\u043D\u043E \u0441\u044A\u0435\u0434\u0435\u043D\u043E \u043A\u0440\u0438\u0441\u0442\u0430\u043B\u043B\u043E\u0432: \u00A79#")
							.format((entity.getCapability(CrystalxModVariables.PLAYER_VARIABLES_CAPABILITY, null)
									.orElse(new CrystalxModVariables.PlayerVariables())).simultaneously_eated_blue_crystals))),
					(true));
		}
		if (new Object() {
			...
			if (entity instanceof LivingEntity)
				((LivingEntity) entity).addPotionEffect(new EffectInstance(BlueCrystallinityPotionEffect.potion, (int) (new Object() {
