			...
			if (entity instanceof LivingEntity)
				((LivingEntity) entity).addPotionEffect(new EffectInstance(RedCrystallinityPotionEffect.potion, (int) (new Object() {
					int check(Entity _entity) {
						...
						.orElse(new CrystalxModVariables.PlayerVariables())).simultaneously_eated_red_crystals - 1), (false), (false)));
		} else {
			if (entity instanceof LivingEntity)
				((LivingEntity) entity)
						.addPotionEffect(new EffectInstance(RedCrystallinityPotionEffect.potion, (int) 280,
