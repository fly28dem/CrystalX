...
public class CrystalGreenBlockBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:crystal_green_block")
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("crystal_green_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalGreenItem.block));
		}
