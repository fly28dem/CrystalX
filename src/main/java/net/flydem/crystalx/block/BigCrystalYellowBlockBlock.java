...
import net.flydem.crystalx.item.CrystalYellowItem;
...
public class BigCrystalYellowBlockBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:big_crystal_yellow_block")
	public static final Block block = null;

	public BigCrystalYellowBlockBlock(CrystalxModElements instance) {
		super(instance, 8);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("big_crystal_yellow_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("crystalx:big_crystal_yellow_block"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 100, Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
					...
					.setLightLevel(s -> 7));
			setRegistryName("big_crystal_yellow_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalYellowItem.block, (int) (2)));
		}

		@Override
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			Block ground = state.getBlock();
			return (ground == Blocks.SAND || ground == Blocks.DIRT || ground == Blocks.GRASS_BLOCK || ground == Blocks.STONE
					|| ground == Blocks.COBBLESTONE || ground == Blocks.OAK_PLANKS
