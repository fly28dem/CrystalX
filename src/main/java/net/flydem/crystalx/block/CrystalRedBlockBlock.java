...
public class CrystalRedBlockBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:crystal_red_block")
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalRedItem.block));
		}
