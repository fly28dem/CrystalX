...
import net.flydem.crystalx.item.CrystalRedItem;
...
public class BigCrystalRedBlockBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:big_crystal_red_block")
	public static final Block block = null;

	public BigCrystalRedBlockBlock(CrystalxModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("big_crystal_red_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("crystalx:big_crystal_red_block"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("big_crystal_red_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalRedItem.block, (int) (2)));
		}

		@Override
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			Block ground = state.getBlock();
			return (ground == Blocks.COBBLESTONE || ground == Blocks.STONE || ground == Blocks.DIRT || ground == Blocks.GRASS_BLOCK
					|| ground == Blocks.OAK_PLANKS || ground == Blocks.SAND
