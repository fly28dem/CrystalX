...
public class CrystalBlueBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:crystal_blue_block")
	public static final Block block = null;

	public CrystalBlueBlock(CrystalxModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("crystal_blue_block"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("crystalx:crystal_blue_block"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
			...
			super(Effects.SPEED, 100,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystal_any_destroy")),
									...
									() -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystalany_default")),
									() -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystalany_default"))))
							.hardnessAndResistance(0.3f, 0.5f).setLightLevel(s -> 1));
			setRegistryName("crystal_blue_block");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalXBlueItem.block));
		}
