...
public class BigCrystalBlueBlock extends CrystalxModElements.ModElement {
	@ObjectHolder("crystalx:big_crystal_blue")
	public static final Block block = null;

	public BigCrystalBlueBlock(CrystalxModElements instance) {
		super(instance, 5);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("big_crystal_blue"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("crystalx:big_crystal_blue"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
			...
			super(Effects.SPEED, 100,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement()
							.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystal_any_destroy")),
									...
									() -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystalany_default")),
									() -> new SoundEvent(new ResourceLocation("crystalx:crystalx_crystalany_default"))))
							.hardnessAndResistance(0.5f, 0.5f).setLightLevel(s -> 1));
			setRegistryName("big_crystal_blue");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CrystalXBlueItem.block, (int) (2)));
		}

		@Override
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			Block ground = state.getBlock();
			return (ground == Blocks.STONE || ground == Blocks.COBBLESTONE || ground == Blocks.GRASS_BLOCK || ground == Blocks.DIRT
					|| ground == Blocks.SAND || ground == Blocks.OAK_PLANKS
