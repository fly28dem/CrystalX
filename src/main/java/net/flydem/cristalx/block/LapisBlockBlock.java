...
public class LapisBlockBlock extends CristalxModElements.ModElement {
	@ObjectHolder("cristalx:lapis_block")
	public static final Block block = null;

	public LapisBlockBlock(CristalxModElements instance) {
		super(instance, 1);
	}
